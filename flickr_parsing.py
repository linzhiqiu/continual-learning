...
class Metadata(object):
    ...
    """
    def __init__(self, data, autotag, line_num, hash_dict, exif, save_folder):
        self.metadata = self._parse_metadata(data, autotag, line_num, hash_dict, exif, save_folder)
    ...
    def _parse_metadata(self, data, autotag, line_num, hash_dict, exif, save_folder):
        ...
        exif_ID, exif_number = self._parse_line(exif)
    ...
    def _load_files(self):
        ...
        with open(self.data_file, "r") as f, \
            ...
            if type(self.criteria) == ImageByRandom:
                print("Randomly shuffled the data")
                ...
                for i, (data_line, auto_line, line_num, exif_line) in tqdm(enumerate(zip_object)):
                    if i == curr_index:
                        meta = Metadata(data_line, auto_line, line_num, hash_dict, exif_line, self.save_folder)
