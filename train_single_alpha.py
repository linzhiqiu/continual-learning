...
from train import get_loader_func, get_all_loaders_from_features_dict, get_loaders_from_features_dict
...
if __name__ == '__main__':
    ...
    for alpha_value in ALPHA_VALUE_DICT[args.alpha_value_mode]:
        ...
        alpha_loaders_dict_path = os.path.join(exp_result_save_path,
                                               f"alpha_loaders_dict_{dataset_str(args.mode)}_singlememory_{args.alpha_value_mode}_{alpha_value}_{args.train_mode}_{seed_str}_ex_{excluded_bucket_idx}.pickle")
        ...
        results_dict_alpha_retrain_path = os.path.join(exp_result_save_path,
                                                       f"results_dict_singlememory_{args.alpha_value_mode}_{alpha_value}_retrain_{dataset_str(args.mode)}_{args.train_mode}_{seed_str}_ex_{excluded_bucket_idx}.pickle")
        ...
        results_dict_alpha_finetune_path = os.path.join(exp_result_save_path,
                                                       f"results_dict_singlememory_{args.alpha_value_mode}_{alpha_value}_finetune_{dataset_str(args.mode)}_{args.train_mode}_{seed_str}_ex_{excluded_bucket_idx}.pickle")
    ...
    results_dict_single_path = os.path.join(exp_result_save_path,
                                            f"results_dict_single_with_all_{dataset_str(args.mode)}_{args.train_mode}_{seed_str}_ex_{excluded_bucket_idx}.pickle")
    ...
    results_dict_single_finetune_path = os.path.join(exp_result_save_path,
                                                     f"results_dict_single_with_all_finetune_{dataset_str(args.mode)}_{args.train_mode}_{seed_str}_ex_{excluded_bucket_idx}.pickle")
